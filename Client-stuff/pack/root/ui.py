...
class EditLine(TextLine):
	...
	def __init__(self):
		...
		if app.INGAME_REGISTER or app.INGAME_WIKI:
...
class ImageBox(Window):
	def __init__(self, layer = "UI"):
		...
		self.eventDict={}
		self.eventFunc = {"mouse_click" : None, "mouse_click_down" : None, "mouse_over_in" : None, "mouse_over_out" : None}
		self.eventArgs = {"mouse_click" : None, "mouse_click_down" : None, "mouse_over_in" : None, "mouse_over_out" : None}
	...
	if app.INGAME_WIKI:
		...
		def SetEventWiki(self, func, *args):
			result = self.eventFunc.has_key(args[0])
			if result:
				new_args=args
				...
				self.eventFunc[args[0]] = func
				self.eventArgs[args[0]] = new_args_list
			else:
				print "[ERROR] ui.py SetEventWiki, Can`t Find has_key : %s" % args[0]

		def OnMouseLeftButtonDown(self):
			if self.eventFunc["mouse_click_down"]:
				apply(self.eventFunc["mouse_click_down"], self.eventArgs["mouse_click_down"])
