...
class CharacterWindow(ui.ScriptWindow):
	...
	def __BindObject(self):
		...
		if app.ENABLE_CONQUEROR_LEVEL:
			#self.GetChild("Tab_01").SetEvent(ui.__mem_func__(self.__OverInImage), "mouse_over_in", localeInfo.STAT_TOOLTIP_TAB_CHARACTER)
			#self.GetChild("Tab_01").SetEvent(ui.__mem_func__(self.__OverOutImage), "mouse_over_out")
			#self.GetChild("Tab_02").SetEvent(ui.__mem_func__(self.__OverInImage), "mouse_over_in", localeInfo.STAT_TOOLTIP_TAB_SKILL)
			#self.GetChild("Tab_02").SetEvent(ui.__mem_func__(self.__OverOutImage), "mouse_over_out")
			#self.GetChild("Tab_03").SetEvent(ui.__mem_func__(self.__OverInImage), "mouse_over_in", localeInfo.STAT_TOOLTIP_TAB_EMOTICON)
			#self.GetChild("Tab_03").SetEvent(ui.__mem_func__(self.__OverOutImage), "mouse_over_out")
			#self.GetChild("Tab_04").SetEvent(ui.__mem_func__(self.__OverInImage), "mouse_over_in", localeInfo.STAT_TOOLTIP_TAB_QUEST)
			#self.GetChild("Tab_04").SetEvent(ui.__mem_func__(self.__OverOutImage), "mouse_over_out")
