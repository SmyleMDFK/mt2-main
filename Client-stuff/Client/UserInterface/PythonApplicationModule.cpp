...
void initapp()
{
	...
	PyModule_AddIntConstant(poModule, "ENABLE_STEAM", true);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_STEAM", false);
#endif
#if defined(LOGIN_TYPE_STEAM)
	PyModule_AddIntConstant(poModule, "LOGIN_TYPE_STEAM", true);
#else
	PyModule_AddIntConstant(poModule, "LOGIN_TYPE_STEAM", false);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_USER_SITUATION_NOTICE", true);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_USER_SITUATION_NOTICE", false);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_WEB_LINKED_BANNER", true);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_WEB_LINKED_BANNER", false);
#endif
...
#if defined(INGAME_WIKI)_WOLFMAN
	...
	PyModule_AddIntConstant(poModule, "INGAME_WIKI_WOLFMAN", false);
#endif
#if defined(ENABLE_AUTO_ATTACK)
	PyModule_AddIntConstant(poModule, "ENABLE_AUTO_ATTACK", true);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_AUTO_ATTACK", false);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_PVP_BALANCE", true);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PVP_BALANCE", false);
#endif
