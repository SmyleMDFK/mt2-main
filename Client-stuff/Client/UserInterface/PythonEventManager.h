...
class CPythonEventManager : public CSingleton<CPythonEventManager>
{
	...
	public:
		...
		void SetFontColor(int32_t index, float r, float g, float b, float a);
		void SetVisibleLineCount(int32_t index, int32_t linecount);
		int32_t GetLineHeight(int32_t index);
		void SetYPosition(int32_t index, int32_t y);
		int32_t GetProcessedLineCount(int32_t index);
		void AllProcessEventSet(int32_t index);
		int32_t GetTotalLineCount(int32_t index);
