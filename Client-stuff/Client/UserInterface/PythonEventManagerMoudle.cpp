...
PyObject * eventSetFontColor(PyObject* poSelf, PyObject* poArgs) {
	...
	float a = 1.0f;
	PyTuple_GetFloat(poArgs, 4, &a);

	CPythonEventManager::Instance().SetFontColor(index, r, g, b, a);
	return Py_BuildNone();
}
...
PyObject * eventSetVisibleLineCount(PyObject* poSelf, PyObject* poArgs) {
	...
	CPythonEventManager::Instance().SetVisibleLineCount(index, linecount);
	return Py_BuildNone();
}
...
PyObject * eventGetLineHeight(PyObject* poSelf, PyObject* poArgs) {
	...
	return Py_BuildValue("i", CPythonEventManager::Instance().GetLineHeight(index));
}
...
PyObject * eventSetYPosition(PyObject* poSelf, PyObject* poArgs) {
	...
	CPythonEventManager::Instance().SetYPosition(index, y);
	return Py_BuildNone();
}
...
PyObject * eventGetProcessedLineCount(PyObject* poSelf, PyObject* poArgs) {
	...
	return Py_BuildValue("i", CPythonEventManager::Instance().GetProcessedLineCount(index));
}
...
PyObject * eventAllProcessEventSet(PyObject* poSelf, PyObject* poArgs) {
	...
	CPythonEventManager::Instance().AllProcessEventSet(index);
	return Py_BuildNone();
}
...
PyObject * eventGetTotalLineCount(PyObject* poSelf, PyObject* poArgs) {
	...
	return Py_BuildValue("i", CPythonEventManager::Instance().GetTotalLineCount(index));
}
