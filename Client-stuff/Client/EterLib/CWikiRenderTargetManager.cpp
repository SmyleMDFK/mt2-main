...
std::shared_ptr<CWikiRenderTarget> CWikiRenderTargetManager::GetRenderTarget(const int32_t module_id)
{
...
bool CWikiRenderTargetManager::CreateRenderTarget(const int32_t module_id, const int32_t width, const int32_t height)
{
...
void CWikiRenderTargetManager::DeleteRenderTarget(const int32_t module_id)
{
