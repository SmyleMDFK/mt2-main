...
bool CGraphicWikiRenderTargetTexture::Create(const int32_t width, const int32_t height, const D3DFORMAT texFormat, const D3DFORMAT depthFormat)
{
	Reset();
...
bool CGraphicWikiRenderTargetTexture::CreateRenderTexture(const int32_t width, const int32_t height, const D3DFORMAT format)
{
	m_d3dFormat = format;
...
bool CGraphicWikiRenderTargetTexture::CreateRenderDepthStencil(const int32_t width, const int32_t height, const D3DFORMAT format)
{
